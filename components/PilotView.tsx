...
const PilotView: React.FC = () => {
  ...
  const dashboardData = useMemo(() => {
    ...
    if (isSingleCampus) {
        ...
        if (campus === 'Travis Heights HS') baseEnrollment += 400;
        if (campus === 'Capital City HS') baseEnrollment -= 200;
    } else {
    ...
    } else if (campus === 'Capital City HS') {
         demographicData = [
    ...
    if (campus === 'Travis Heights HS') baseAttendance += 1.5; // Higher performing
    if (campus === 'Lady Bird HS') baseAttendance -= 1.0;
    ...
    if (campus === 'Lady Bird HS') baseIncidents *= 1.2;
    ...
    <div className="max-w-7xl mx-auto p-6 pb-24 font-sans text-slate-800">
      ...
      <div className="bg-white border-b border-gray-300 px-4 py-3 flex justify-between items-center mb-6 shadow-sm sticky top-0 z-20 rounded-lg">
        <div className="flex items-center gap-3">
           ...
           <div>
              <h1 className="text-lg font-medium text-gray-900 leading-tight">Lone Star USD - District Dashboard</h1>
             ...
             <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-4 space-y-4 sticky top-24">
                ...
                <div className="space-y-1">
                    ...
                    >
                        ...
                        <option>Capital City HS</option>
                        <option>Travis Heights HS</option>
                        <option>Lady Bird HS</option>
                    </select>
                </div>
                            ...
                            <div className="h-64 w-full">
                                <ResponsiveContainer width="100%" height="100%">
                                    <AreaChart data={dashboardData.enrollmentTrend} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
                                        ...
                                        <Area type="monotone" dataKey="value" stroke="#BF5700" strokeWidth={2} fillOpacity={1} fill="url(#colorEnroll)" />
                                    </AreaChart>
                                </ResponsiveContainer>
                            </div>
                        </div>
                                    ...
                                    <PieChart>
                                        ...
                                        >
                                            {dashboardData.demographicData.map((entry, index) => (
                                                <Cell key={`cell-${index}`} fill={entry.color === '#3b82f6' ? '#BF5700' : entry.color} />
                                            ))}
                                        </Pie>
                            ...
                            <div className="h-64 w-full">
                                <ResponsiveContainer width="100%" height="100%">
                                    <BarChart data={dashboardData.disciplineByMonth}>
                                        ...
                                        <Tooltip contentStyle={{borderRadius: '4px', fontSize: '12px'}} cursor={{fill: '#f3f4f6'}} />
                                        <Bar dataKey="incidents" fill="#BF5700" radius={[4, 4, 0, 0]} barSize={40} />
                                    </BarChart>
                                </ResponsiveContainer>
                            </div>
                        </div>
                            ...
                            <table className="w-full text-xs text-left text-gray-600">
                                ...
                                <tbody className="divide-y divide-gray-100">
                                    <tr className="hover:bg-gray-50">
                                        ...
                                        <td className="px-4 py-3">Capital City HS</td>
                                    ...
                                    <tr className="hover:bg-gray-50">
                                        ...
                                        <td className="px-4 py-3">Lady Bird HS</td>
                                    ...
                                    <tr className="hover:bg-gray-50">
                                        ...
                                        <td className="px-4 py-3">Travis Heights HS</td>
