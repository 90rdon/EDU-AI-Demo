...
const CampusView: React.FC<ViewProps> = ({ isAiOpen, setIsAiOpen }) => {
    ...
    const [hasClickedGrowth, setHasClickedGrowth] = useState(false);

    // AI Context Data
    const campusContext = `
    Campus: Capital City High School.
    Enrollment: 2,450.
    Avg Attendance: 94.2%.
  ...
  `;
    ...
    // Trigger Hint
    useEffect(() => {
        if (hasClickedGrowth) return;
        const timer = setTimeout(() => setShowGrowthHint(true), 2000);
    ...
    const handleGrowthClick = () => {
        setHasClickedGrowth(true);
        setShowGrowthHint(false);
        launchAi("Generate a Growth Report Line Chart showing growth trends for the 10th grade math cohort.");
    };
    ...
    return (
        <div className="min-h-screen bg-gray-50 font-sans relative">
            ...
            {/* EduAI Sidebar */}
            <EduAI isOpen={isAiOpen} onClose={() => setIsAiOpen(false)} contextData={campusContext} initialPrompt={aiPrompt} role="Principal" />

            {/* Teacher Detail Modal */}
            {selectedTeacher && (
                <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-fadeIn">
                    <div className="bg-white rounded-xl shadow-2xl max-w-2xl w-full overflow-hidden">
                        <div className="bg-vt-darkBlue text-white p-6 flex justify-between items-start">
                            <div>
                        ...
                        <div className="p-6 space-y-6">
                            ...
                            <div className="bg-indigo-50 rounded-xl p-5 border border-indigo-100">
                                ...
                                <div className="flex gap-2 mt-4 justify-end">
                                    ...
                                    <button className="px-3 py-1.5 bg-vt-blue text-white rounded text-xs font-bold hover:bg-vt-lightBlue flex items-center gap-1">
                    ...
                    <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-500 font-medium mt-1">Capital City High School</p>
                            </div>
                        </div>
                ...
                <div className="bg-gradient-to-r from-vt-blue to-vt-lightBlue px-6 py-10 text-white shadow-lg relative overflow-hidden">
                    ...
                    <div className="max-w-7xl mx-auto relative z-10">
                        ...
                        <div className="mt-6 flex gap-3">
                            ...
                            >
                                <Sparkles size={16} className="text-vt-blue" /> Launch EDU AI
                            </button>

                            {/* Growth Report Button with Hint */}
                            <div className="relative">
                                ...
                                {showGrowthHint && (
                                    <div className="absolute -top-14 left-1/2 transform -translate-x-1/2 z-20 animate-bounce pointer-events-none min-w-[150px]">
